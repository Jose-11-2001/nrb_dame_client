...
export default function Dashboard() {
  ...
  const stats = [
    ...
    { label: 'Pending Applications', value: applications.filter((a: any) => a.status === 'PENDING').length, color: 'bg-yellow-600' },
    { label: 'Verified Applications', value: applications.filter((a: any) => a.status === 'VERIFIED').length, color: 'bg-green-600' },
